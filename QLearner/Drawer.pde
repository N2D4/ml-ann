...
public class Slider extends GUIElement {
  ...
  @Override public void draw(int x, int y, int width, int height, int columnWidth, int textHeight, boolean selected) {
    noStroke();
    fill(#FFFFFF);
    textSize(textHeight);
    textAlign(LEFT, CENTER);
    text(caption + ": " + String.format(formatString, getValue()), x, y, columnWidth, height);
  }
  
  @Override public void increment(int by) {
